...
month = 10
source_file_name1 = "good_sample10-Copy.csv"
source_file_name2 = "10_10_HWWEFault_OLD_dropLastDay_Z1X_1month.csv"
experiment_type = 'test_get_cv_result_' + str(month) + "_good_sample_filter_bad_init"
year= None
addsum = False
adddiff = False
addsigma = False
...
def generate_data(fault_month_start, fault_month_stop, good_month_start, good_month_stop, good_training_ratio,
    ...
    good = pd.read_csv(source_file_name1,nrows = nrows_test)
...
# get top number 3    
    good = multiProcPreprocess2(good.groupby('SerialNumber'),15,set(good_disks)) 
    bad = multiProcPreprocess2(bad.groupby('SerialNumber'),15,set(fault_disks)) 
...
if __name__ == "__main__":
    ...
    good_training_ratio = float(arguments['--good_training_ratio'])
    fault_training_ratio = float(arguments['--fault_training_ratio'])
