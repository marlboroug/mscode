...
featureid = 3
keep_feature =[]
source_file_name_good = "test_10_month_feature_Good_python_all_before_15.csv"#test_8_month_feature_bad_python_all  test_8_month_feature_Good_python_all
source_file_name_bad = "test_" +str(month) +"_month_feature_bad_python_all.csv"
experiment_type = 'test_get_cv_result_sampleall_month_' + str(month) + "_front_15_featureid_" + str(featureid)
