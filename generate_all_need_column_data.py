...
nrows_test = None
source_file_name1 = '11_30_DPF_good_9month.csv'  #8 
source_file_name2 = '11_30_DPF_good_10month.csv' #9
source_file_name3 = '11_30_DPF_good_11month.csv' #10

source_file_name4 = '11_30_DPF_fault_9month.csv'  #8 
source_file_name5 = '11_30_DPF_fault_10month.csv' #9
source_file_name6 = '11_30_DPF_fault_11month.csv' #10

experiment_type = 'generate_sample_good_data_and_bad_data'
year = 2016
...
##replace nan with mode
      ...
      bad9.to_csv('all_bad9_somecolum.csv', index=None)
      logging.warning('save all_bad9_somecolum.')
      bad10.to_csv('all_bad10_somecolumn.csv', index=None)
      logging.warning('save all_bad10_somecolumn.')
      bad11.to_csv('all_bad11_somecolumn.csv', index=None)
      logging.warning('save all_bad11_somecolumn.')    
      
      good9.to_csv('all_good9_somecolumn.csv', index=None)
      logging.warning('save all_good9_somecolumn.')
      good10.to_csv('all_good10_somecolumn.csv', index=None)
      logging.warning('save all_good10_somecolumn.')
      good11.to_csv('all_good11_somecolumn.csv', index=None)
      logging.warning('save all_good11_somecolumn.')        
