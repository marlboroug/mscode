...
#            if name in ['FailureCategory','model', 'capacity_bytes','FaultTimeStamp','EventId','ParsingError','AAMFeature','APMFeature','ATASecurity','ATAVersion','Device','DeviceModel','FirmwareVersion','ModelFamily','RdLookAhead','RotationRate','SMARTSupport','SATAVersion','SectorSize','UserCapacity','WriteCache','WtCacheReorder']:
#                to_be_deleted.append(name)
#            elif name  in ['TakenOut','Min_DiskPartFailedTime','Max_DiskPartFailedTime',"LabelId","SerialNumber","PreciseTimeStamp","NodeId" ]: 
#                continue
